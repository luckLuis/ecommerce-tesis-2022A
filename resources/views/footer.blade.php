...
<div class="container-fluid bg-light footer_title">
    <footer class="row  py-4 my-5 border-top border-5">

        <div class="col-1 mx-5">
            <h5>{{ __('HELP') }}</h5>
            <ul class="nav flex-column letters_footer">
                <li class="nav-item mb-2 "><a href="/contact" class="nav-link p-0 text-muted">{{ __('CONTACT US') }}</a>
                </li>
            </ul>
        </div>
        <div class="col-md mx-5">
            <h5>{{ __('MY ACCOUNT') }}</h5>
            <ul class="nav flex-column letters_footer">
                <li class="nav-item mb-2"><a href="/profile" class="nav-link p-0 text-muted">{{ __('MY ACCOUNT') }}</a>
                </li>
            </ul>
        </div>
